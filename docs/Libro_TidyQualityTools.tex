...
\DocumentationTok{\#\# [1] 0.1502285}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.3916464}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.3627036}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mazo}\SpecialCharTok{$}\NormalTok{.cartas}
\DocumentationTok{\#\#  [1] "4♠"  "10♥" "10♣" "10♠" "4♦"  "A♦"  "A♠"  "J♠"  "8♣"  "10♦" "9♥"  "8♦" }
\DocumentationTok{\#\# [13] "3♣"  "J♦"  "6♠"  "4♥"  "9♦"  "2♥"  "Q♠"  "J♥"  "K♣"  "Q♦"  "5♣"  "2♠" }
\DocumentationTok{\#\# [25] "7♠"  "9♣"  "5♦"  "2♣"  "8♠"  "2♦"  "K♥"  "K♦"  "3♥"  "6♣"  "4♣"  "6♦" }
\DocumentationTok{\#\# [37] "A♣"  "8♥"  "3♠"  "5♠"  "J♣"  "6♥"  "Q♥"  "K♠"  "7♦"  "9♠"  "5♥"  "7♣" }
\DocumentationTok{\#\# [49] "Q♣"  "7♥"  "A♥"  "3♦"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.5260441}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.01245125}
...
## -0.0269575 -0.0039654  0.0002145  0.0039653  0.0289459 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 0.0001130  0.0003097   0.365    0.715    
## V           0.8133641  0.0226393  35.927   <2e-16 ***
## ---
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Nueva Función (se quita argumento \textasciigrave{}las\textasciigrave{})}
\NormalTok{ParetoChart\_ }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (x, weight, }\AttributeTok{showTable =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{showPlot =} \ConstantTok{TRUE}\NormalTok{, main, col, border, xlab, }\AttributeTok{ylab =} \StringTok{"Frequency"}\NormalTok{, percentVec, ...)}
\NormalTok{\{}
...
\NormalTok{  corp.border }\OtherTok{=} \StringTok{"\#9E0138"}
  \ControlFlowTok{if}\NormalTok{ (}\SpecialCharTok{!}\FunctionTok{is.vector}\NormalTok{(x) }\SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.data.frame}\NormalTok{(x) }\SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.table}\NormalTok{(x))}
    \FunctionTok{stop}\NormalTok{(}\StringTok{"x should be a vector, dataframe or a table"}\NormalTok{)}
...
\NormalTok{    main }\OtherTok{=} \FunctionTok{paste}\NormalTok{(}\StringTok{"Pareto Chart for"}\NormalTok{, varName)}
...
\NormalTok{    data }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Frequency =}\NormalTok{ xtable,}
                       \AttributeTok{Cum.Frequency =}\NormalTok{ cumFreq,}
                       \AttributeTok{Percentage =} \FunctionTok{round}\NormalTok{(percentage, }\AttributeTok{digits =} \DecValTok{2}\NormalTok{),}
                       \AttributeTok{Cum.Percentage =} \FunctionTok{round}\NormalTok{(cumPerc, }\AttributeTok{digits =} \DecValTok{2}\NormalTok{))}
\NormalTok{    tabla }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(data)}
    
\NormalTok{    p }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(data, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{reorder}\NormalTok{(}\FunctionTok{names}\NormalTok{(xtable), }\SpecialCharTok{{-}}\NormalTok{xtable), }\AttributeTok{y =}\NormalTok{ Frequency)) }\SpecialCharTok{+}
      \FunctionTok{geom\_col}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{fill =} \StringTok{"Frequency"}\NormalTok{), }\AttributeTok{width =} \FloatTok{0.7}\NormalTok{) }\SpecialCharTok{+}
      \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ Cum.Frequency, }\AttributeTok{color =} \StringTok{"Cumulative Percentage"}\NormalTok{), }\AttributeTok{size =} \DecValTok{3}\NormalTok{) }\SpecialCharTok{+}
      \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ Cum.Frequency, }\AttributeTok{group =} \DecValTok{1}\NormalTok{, }\AttributeTok{color =} \StringTok{"Cumulative Percentage"}\NormalTok{), }\AttributeTok{line =} \FloatTok{0.5}\NormalTok{) }\SpecialCharTok{+}
      \FunctionTok{scale\_y\_continuous}\NormalTok{(}\AttributeTok{name =}\NormalTok{ ylab,}
                         \AttributeTok{sec.axis =} \FunctionTok{sec\_axis}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ . }\SpecialCharTok{/} \FunctionTok{sum}\NormalTok{(xtable),}
                                             \AttributeTok{name =} \StringTok{"Cumulative Percentage"}\NormalTok{,}
      ...
      \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(border, border)) }\SpecialCharTok{+}
      \FunctionTok{scale\_fill\_manual}\NormalTok{(}\AttributeTok{values =}\NormalTok{ col) }\SpecialCharTok{+}
      \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"none"}\NormalTok{) }\SpecialCharTok{+}
      \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =}\NormalTok{ main)}\SpecialCharTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cg\_RunChart }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (x, target, tolerance, ref.interval, facCg, facCgk,}
                         ...
                         \AttributeTok{conf.level =} \FloatTok{0.95}\NormalTok{, }\AttributeTok{cgOut =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{\{}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(x)) \{}
...
\NormalTok{  df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ x)}
  
  \CommentTok{\# Add target line}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{y\_target }\OtherTok{\textless{}{-}}\NormalTok{ target}
  
  \CommentTok{\# Calculate the upper and lower control limits}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{y\_lower }\OtherTok{\textless{}{-}}\NormalTok{ quant1}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{y\_upper }\OtherTok{\textless{}{-}}\NormalTok{ quant2}
  \CommentTok{\# Calculate the tolerance limits}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{y\_tolerance\_lower }\OtherTok{\textless{}{-}}\NormalTok{ tolerance[}\DecValTok{1}\NormalTok{]}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{y\_tolerance\_upper }\OtherTok{\textless{}{-}}\NormalTok{ tolerance[}\DecValTok{2}\NormalTok{]}
  
  \CommentTok{\# Calculate the mean}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{y\_mean }\OtherTok{\textless{}{-}}\NormalTok{ mean}
  
  \CommentTok{\# Calculate the Cg and Cgk values}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{Cg }\OtherTok{\textless{}{-}}\NormalTok{ Cg}
\NormalTok{  df}\SpecialCharTok{$}\NormalTok{Cgk }\OtherTok{\textless{}{-}}\NormalTok{ Cgk}
  
  \CommentTok{\# Create the ggplot}
  \CommentTok{\# 1. Principal plot and target line}
\NormalTok{  p }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{seq\_along}\NormalTok{(x), }\AttributeTok{y =}\NormalTok{ x)) }\SpecialCharTok{+}
    ...
    \FunctionTok{theme\_minimal}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{,}\AttributeTok{face =} \StringTok{"bold"}\NormalTok{))}\SpecialCharTok{+}
...
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"loess"}\NormalTok{, }\AttributeTok{color =} \StringTok{"red"}\NormalTok{, }\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{span =} \FloatTok{1.25}\NormalTok{, }\AttributeTok{size =} \FloatTok{0.25}\NormalTok{,)}
  ...
  \CommentTok{\# 3. Green lines}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ mean), }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{, }\AttributeTok{color =} \StringTok{"seagreen"}\NormalTok{)}\SpecialCharTok{+}  \CommentTok{\#center line}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ quant1), }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{, }\AttributeTok{color =} \StringTok{"seagreen"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# Bottom line}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ quant2), }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{, }\AttributeTok{color =} \StringTok{"seagreen"}\NormalTok{)   }\CommentTok{\# Top line}
...
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =} \FunctionTok{c}\NormalTok{(target }\SpecialCharTok{+}\NormalTok{ n}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(tolerance))), target }\SpecialCharTok{{-}}\NormalTok{ n}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(tolerance)))), }\AttributeTok{color =} \StringTok{"\#012B78"}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"solid"}\NormalTok{) }\CommentTok{\# Agregar líneas}
  \CommentTok{\#Label}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{scale\_y\_continuous}\NormalTok{(}\AttributeTok{limits =}\NormalTok{ ylim, }\AttributeTok{expand =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{),}\AttributeTok{sec.axis =} 
                                \FunctionTok{sec\_axis}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ .,}\AttributeTok{breaks =} \FunctionTok{c}\NormalTok{(target,mean,quant1,quant2,target }\SpecialCharTok{+}\NormalTok{ n}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(tolerance))),}
\NormalTok{                                                        target }\SpecialCharTok{{-}}\NormalTok{ n}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(tolerance)))),}
                                         \AttributeTok{labels=}\FunctionTok{c}\NormalTok{(}\StringTok{"target"}\NormalTok{,}\FunctionTok{expression}\NormalTok{(}\FunctionTok{bar}\NormalTok{(x)),}\FunctionTok{substitute}\NormalTok{(x[a }\SpecialCharTok{*}\NormalTok{ b], }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(((}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ ref.interval)}\SpecialCharTok{/}\DecValTok{2}\NormalTok{) }\SpecialCharTok{*} \DecValTok{100}\NormalTok{, }\DecValTok{3}\NormalTok{), }\AttributeTok{b =} \StringTok{"\%"}\NormalTok{)),}
                                                  \FunctionTok{substitute}\NormalTok{(x[a }\SpecialCharTok{*}\NormalTok{ b], }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(((ref.interval }\SpecialCharTok{+}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ ref.interval)}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)) }\SpecialCharTok{*} \DecValTok{100}\NormalTok{,}
                                                                                      \DecValTok{3}\NormalTok{), }\AttributeTok{b =} \StringTok{"\%"}\NormalTok{)),}\FunctionTok{substitute}\NormalTok{(x[tar] }\SpecialCharTok{+}\NormalTok{ a, }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(n}\SpecialCharTok{/}\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{))),}\FunctionTok{substitute}\NormalTok{(x[tar] }\SpecialCharTok{{-}}\NormalTok{ a, }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(n}\SpecialCharTok{/}\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{))))))}\SpecialCharTok{+}
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text.y.right =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size =} \DecValTok{15}\NormalTok{))}
  
  \CommentTok{\# Label  Cg and Cgk}
...
\NormalTok{        )}
\NormalTok{      )}
    \FunctionTok{suppressMessages}\NormalTok{(}\FunctionTok{show}\NormalTok{(p))}
\NormalTok{  \}}
  \ControlFlowTok{else}\NormalTok{\{}
    \FunctionTok{suppressMessages}\NormalTok{(}\FunctionTok{show}\NormalTok{(p))}
\NormalTok{  \}}
...
\NormalTok{cg\_HistChart }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (x, target, tolerance, ref.interval, facCg, facCgk,}
                          \AttributeTok{n =} \FloatTok{0.2}\NormalTok{, col, xlim, ylim, main, }\AttributeTok{conf.level =} \FloatTok{0.95}\NormalTok{, }\AttributeTok{cgOut =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{\{}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(x))}
    \FunctionTok{stop}\NormalTok{(}\StringTok{"x must be given as a vector"}\NormalTok{)}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(target)) \{}
...
\NormalTok{                 sd)}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{length}\NormalTok{(tolerance) }\SpecialCharTok{!=} \DecValTok{2}\NormalTok{)}
    \FunctionTok{stop}\NormalTok{(}\StringTok{"tolerance has wrong length"}\NormalTok{)}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(col))}
\NormalTok{    col }\OtherTok{=} \StringTok{"lightblue"}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(xlim))}
\NormalTok{    xlim }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FunctionTok{length}\NormalTok{(x))}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(ylim))}
\NormalTok{    ylim }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\FunctionTok{min}\NormalTok{(x, target }\SpecialCharTok{{-}}\NormalTok{ n}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(tolerance))),}
...
\NormalTok{                                      quant1, quant2))}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(main))}
\NormalTok{    main }\OtherTok{=} \FunctionTok{paste}\NormalTok{(}\StringTok{"Histogram of"}\NormalTok{, }\FunctionTok{deparse}\NormalTok{(}\FunctionTok{substitute}\NormalTok{(x)),}
                 \StringTok{"{-} target"}\NormalTok{)}
  
\NormalTok{  Cg }\OtherTok{\textless{}{-}}\NormalTok{ (facCg }\SpecialCharTok{*}\NormalTok{ tolerance[}\DecValTok{2}\NormalTok{]}\SpecialCharTok{{-}}\NormalTok{tolerance[}\DecValTok{1}\NormalTok{])}\SpecialCharTok{/}\NormalTok{ref.interval}
\NormalTok{  Cgk }\OtherTok{\textless{}{-}}\NormalTok{ (facCgk }\SpecialCharTok{*} \FunctionTok{abs}\NormalTok{(target}\SpecialCharTok{{-}}\FunctionTok{mean}\NormalTok{(x))}\SpecialCharTok{/}\NormalTok{(ref.interval}\SpecialCharTok{/}\DecValTok{2}\NormalTok{))}
  
  \CommentTok{\# Calculos previos}
\NormalTok{  x.c }\OtherTok{\textless{}{-}}\NormalTok{ x }\SpecialCharTok{{-}}\NormalTok{ target}
\NormalTok{  temp }\OtherTok{\textless{}{-}} \FunctionTok{hist}\NormalTok{(x.c, }\AttributeTok{plot =} \ConstantTok{FALSE}\NormalTok{)}
  \CommentTok{\# Obtenemos la información para el histograma}
\NormalTok{  df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
    \AttributeTok{mid =}\NormalTok{ temp}\SpecialCharTok{$}\NormalTok{mids,}
    \AttributeTok{density =}\NormalTok{ temp}\SpecialCharTok{$}\NormalTok{density}
\NormalTok{  )}
\NormalTok{  width }\OtherTok{\textless{}{-}} \FunctionTok{diff}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{mid)[}\DecValTok{1}\NormalTok{] }\CommentTok{\# Ancho de cada barra}
  \CommentTok{\# Histograma}
\NormalTok{  p }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ mid, }\AttributeTok{y =}\NormalTok{ density)) }\SpecialCharTok{+}
    \FunctionTok{geom\_bar}\NormalTok{(}\AttributeTok{stat =} \StringTok{"identity"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ width, }\AttributeTok{fill =} \StringTok{"lightblue"}\NormalTok{, }\AttributeTok{color =} \StringTok{"black"}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.5}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{y =} \StringTok{"Density"}\NormalTok{, }\AttributeTok{x =} \StringTok{"x.c"}\NormalTok{, }\AttributeTok{title =}\NormalTok{ main) }\SpecialCharTok{+}
    \FunctionTok{theme\_minimal}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{,}\AttributeTok{face =} \StringTok{"bold"}\NormalTok{))}\SpecialCharTok{+}
    \FunctionTok{guides}\NormalTok{(}\AttributeTok{color =} \FunctionTok{guide\_legend}\NormalTok{(}\AttributeTok{title.position =} \StringTok{"top"}\NormalTok{, }\AttributeTok{title.hjust =} \FloatTok{0.5}\NormalTok{))}
  \CommentTok{\# Linea x=0}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \DecValTok{0}\NormalTok{, }\AttributeTok{color =} \StringTok{"red"}\NormalTok{)}
  \CommentTok{\# Intervalos de Confianza {-} Azules}
\NormalTok{  test }\OtherTok{=} \FunctionTok{t.test}\NormalTok{(x.c, }\AttributeTok{mu =} \DecValTok{0}\NormalTok{, }\AttributeTok{conf.level =}\NormalTok{ conf.level)}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{geom\_vline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{xintercept =}\NormalTok{ test}\SpecialCharTok{$}\NormalTok{conf.int[}\DecValTok{1}\NormalTok{], }\AttributeTok{color =} \StringTok{"Confidence interval"}\NormalTok{), }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{, }\AttributeTok{col =} \StringTok{"blue"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_vline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{xintercept =}\NormalTok{ test}\SpecialCharTok{$}\NormalTok{conf.int[}\DecValTok{2}\NormalTok{], }\AttributeTok{color =} \StringTok{"Confidence interval"}\NormalTok{), }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{, }\AttributeTok{col =} \StringTok{"blue"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"none"}\NormalTok{)}
  \CommentTok{\# Curva de densidad}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{data =} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =} \FunctionTok{density}\NormalTok{(x.c)}\SpecialCharTok{$}\NormalTok{x, }\AttributeTok{y =} \FunctionTok{density}\NormalTok{(x.c)}\SpecialCharTok{$}\NormalTok{y), }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ y), }\AttributeTok{color =} \StringTok{"black"}\NormalTok{, }\AttributeTok{linewidth =} \FloatTok{0.5}\NormalTok{)}
  
  \CommentTok{\# Hipotesis, P\_val y t\_val}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{annotation\_custom}\NormalTok{(}\AttributeTok{grob =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{textGrob}\NormalTok{(}\AttributeTok{label =} \FunctionTok{c}\NormalTok{(}\FunctionTok{expression}\NormalTok{(}\FunctionTok{paste}\NormalTok{(H[}\DecValTok{0}\NormalTok{], }\StringTok{" : Bias = 0"}\NormalTok{))),}
                                                   \AttributeTok{x =} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"cm"}\NormalTok{), }\AttributeTok{y =} \FunctionTok{unit}\NormalTok{(}\DecValTok{1}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
                                                   \AttributeTok{just =} \FunctionTok{c}\NormalTok{(}\StringTok{"left"}\NormalTok{, }\StringTok{"top"}\NormalTok{),}
                                                   \AttributeTok{gp =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{12}\NormalTok{, }\AttributeTok{fontface =} \StringTok{"bold"}\NormalTok{)}
\NormalTok{  )}
\NormalTok{  ) }\SpecialCharTok{+}
    \FunctionTok{annotation\_custom}\NormalTok{( }\AttributeTok{grob =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{textGrob}\NormalTok{( }\AttributeTok{label =} \FunctionTok{c}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"t{-}value: "}\NormalTok{, }\FunctionTok{round}\NormalTok{(test}\SpecialCharTok{$}\NormalTok{statistic, }\DecValTok{3}\NormalTok{))),}
                                              \AttributeTok{x =} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
                                              \AttributeTok{y =} \FunctionTok{unit}\NormalTok{(}\DecValTok{1}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
                                              \AttributeTok{just =} \FunctionTok{c}\NormalTok{(}\StringTok{"left"}\NormalTok{, }\StringTok{"top"}\NormalTok{),}
                                              \AttributeTok{gp =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{11}\NormalTok{)}
\NormalTok{    )}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{annotation\_custom}\NormalTok{(}\AttributeTok{grob =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{textGrob}\NormalTok{(}\AttributeTok{label =} \FunctionTok{c}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"p{-}value: "}\NormalTok{, }\FunctionTok{round}\NormalTok{(test}\SpecialCharTok{$}\NormalTok{p.value, }\DecValTok{3}\NormalTok{))),}
                                            \AttributeTok{x =} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
                                            \AttributeTok{y =} \FunctionTok{unit}\NormalTok{(}\DecValTok{1}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.85}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
                                            \AttributeTok{just =} \FunctionTok{c}\NormalTok{(}\StringTok{"left"}\NormalTok{, }\StringTok{"top"}\NormalTok{),}
                                            \AttributeTok{gp =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{11}\NormalTok{)}
\NormalTok{    )}
\NormalTok{    )}
...
\NormalTok{    p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+}
      \FunctionTok{annotation\_custom}\NormalTok{(}
        \AttributeTok{grob =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{textGrob}\NormalTok{(}
          ...
          \AttributeTok{y =} \FunctionTok{unit}\NormalTok{(}\DecValTok{1}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
          \AttributeTok{just =} \FunctionTok{c}\NormalTok{(}\StringTok{"right"}\NormalTok{, }\StringTok{"top"}\NormalTok{),}
          \AttributeTok{gp =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{12}\NormalTok{)}
\NormalTok{        )}
\NormalTok{      ) }\SpecialCharTok{+}
      \FunctionTok{annotation\_custom}\NormalTok{(}
        \AttributeTok{grob =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{textGrob}\NormalTok{(}
...
\NormalTok{    p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+}
      \FunctionTok{annotation\_custom}\NormalTok{(}
        \AttributeTok{grob =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{textGrob}\NormalTok{(}
          \AttributeTok{label =} \FunctionTok{c}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"{-}{-}{-}{-} conf. int"}\NormalTok{)),}
          \AttributeTok{x =} \FunctionTok{unit}\NormalTok{(}\DecValTok{1}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.15}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
          \AttributeTok{y =} \FunctionTok{unit}\NormalTok{(}\DecValTok{1}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
          \AttributeTok{just =} \FunctionTok{c}\NormalTok{(}\StringTok{"right"}\NormalTok{, }\StringTok{"top"}\NormalTok{),}
          \AttributeTok{gp =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{12}\NormalTok{)}
...
\begin{Highlighting}[]
\CommentTok{\# Nueva Función}
\NormalTok{cg\_ToleranceChart }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (x, target, tolerance, ref.interval, facCg, facCgk,}
                               \AttributeTok{n =} \FloatTok{0.2}\NormalTok{, type, col, pch, xlim, ylim, main, }\AttributeTok{conf.level =} \FloatTok{0.95}\NormalTok{,}
                               \AttributeTok{cgOut =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{\{}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(x))}
    \FunctionTok{stop}\NormalTok{(}\StringTok{"x must be given as a vector"}\NormalTok{)}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(target)) \{}
...
\NormalTok{  p }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(x), }\AttributeTok{y =}\NormalTok{ x), }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ y)) }\SpecialCharTok{+}
    ...
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{""}\NormalTok{, }\AttributeTok{y =} \StringTok{"x"}\NormalTok{, }\AttributeTok{color =} \StringTok{"Variable"}\NormalTok{, }\AttributeTok{title =}\NormalTok{ main)}\SpecialCharTok{+}
    \FunctionTok{theme\_minimal}\NormalTok{()}\SpecialCharTok{+}\FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{,}\AttributeTok{face =} \StringTok{"bold"}\NormalTok{))}\SpecialCharTok{+}
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"none"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Funcion Nueva}
\NormalTok{cg\_ }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (x, target, tolerance, ref.interval, facCg, facCgk, }\AttributeTok{n =} \FloatTok{0.2}\NormalTok{, }
\NormalTok{                 type, col, pch, xlim, ylim, }\AttributeTok{conf.level =} \FloatTok{0.95}\NormalTok{, }\AttributeTok{cex.val =} \FloatTok{1.5}\NormalTok{)}
\NormalTok{\{}
...
\NormalTok{  \}}
  \ControlFlowTok{else}
\NormalTok{    targetmissing }\OtherTok{=} \ConstantTok{TRUE}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(ref.interval))}
\NormalTok{    ref.interval }\OtherTok{=} \FunctionTok{pnorm}\NormalTok{(}\DecValTok{3}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{pnorm}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{3}\NormalTok{)}
\NormalTok{  sd }\OtherTok{=} \FunctionTok{sd}\NormalTok{(x)}
\NormalTok{  mean }\OtherTok{=} \FunctionTok{mean}\NormalTok{(x)}
...
\NormalTok{    xlim }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FunctionTok{length}\NormalTok{(x))}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{missing}\NormalTok{(ylim))}
\NormalTok{    ylim }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\FunctionTok{min}\NormalTok{(x, target }\SpecialCharTok{{-}}\NormalTok{ n }\SpecialCharTok{/} \DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(}
\NormalTok{      tolerance}
\NormalTok{    ))),}
\NormalTok{    quant1, quant2),}
    \FunctionTok{max}\NormalTok{(x, target }\SpecialCharTok{+}\NormalTok{ n }\SpecialCharTok{/} \DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(}
\NormalTok{      tolerance}
\NormalTok{    ))),}
\NormalTok{    quant1, quant2))}
\NormalTok{  Cg }\OtherTok{\textless{}{-}}\NormalTok{ (facCg }\SpecialCharTok{*}\NormalTok{ tolerance[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{{-}}\NormalTok{ tolerance[}\DecValTok{1}\NormalTok{]) }\SpecialCharTok{/}\NormalTok{ ref.interval}
\NormalTok{  Cgk }\OtherTok{\textless{}{-}}\NormalTok{ (facCgk }\SpecialCharTok{*} \FunctionTok{abs}\NormalTok{(target }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(x)) }\SpecialCharTok{/}\NormalTok{ (ref.interval }\SpecialCharTok{/} \DecValTok{2}\NormalTok{))}
  ...
  \CommentTok{\# RunChart}
\NormalTok{  df1 }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ x)}
\NormalTok{  df1}\SpecialCharTok{$}\NormalTok{y\_target }\OtherTok{\textless{}{-}}\NormalTok{ target}
\NormalTok{  df1}\SpecialCharTok{$}\NormalTok{y\_lower }\OtherTok{\textless{}{-}}\NormalTok{ quant1}
\NormalTok{  df1}\SpecialCharTok{$}\NormalTok{y\_upper }\OtherTok{\textless{}{-}}\NormalTok{ quant2}
\NormalTok{  df1}\SpecialCharTok{$}\NormalTok{y\_tolerance\_lower }\OtherTok{\textless{}{-}}\NormalTok{ tolerance[}\DecValTok{1}\NormalTok{]}
\NormalTok{  df1}\SpecialCharTok{$}\NormalTok{y\_tolerance\_upper }\OtherTok{\textless{}{-}}\NormalTok{ tolerance[}\DecValTok{2}\NormalTok{]}
\NormalTok{  df1}\SpecialCharTok{$}\NormalTok{y\_mean }\OtherTok{\textless{}{-}}\NormalTok{ mean}
\NormalTok{  df1}\SpecialCharTok{$}\NormalTok{Cg }\OtherTok{\textless{}{-}}\NormalTok{ Cg}
\NormalTok{  df1}\SpecialCharTok{$}\NormalTok{Cgk }\OtherTok{\textless{}{-}}\NormalTok{ Cgk}
\NormalTok{  p1 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(df1, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{seq\_along}\NormalTok{(x), }\AttributeTok{y =}\NormalTok{ x)) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{color =}\NormalTok{ col, }\AttributeTok{shape =}\NormalTok{ pch) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{color =}\NormalTok{ col, }\AttributeTok{linetype =} \StringTok{"solid"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{scale\_x\_continuous}\NormalTok{(}\AttributeTok{limits =} \FunctionTok{c}\NormalTok{(xlim[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{{-}} \FloatTok{0.05} \SpecialCharTok{*}\NormalTok{ xlim[}\DecValTok{2}\NormalTok{], xlim[}\DecValTok{2}\NormalTok{]),}
                       \AttributeTok{expand =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Run Chart"}\NormalTok{, }\AttributeTok{x =} \StringTok{"Index"}\NormalTok{, }\AttributeTok{y =} \StringTok{"x"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{theme\_minimal}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{face =} \StringTok{"bold"}\NormalTok{)) }\SpecialCharTok{+}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ target)) }\SpecialCharTok{+}
    \FunctionTok{geom\_smooth}\NormalTok{(}
      \AttributeTok{method =} \StringTok{"loess"}\NormalTok{,}
      \AttributeTok{color =} \StringTok{"red"}\NormalTok{,}
      \AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{,}
      \AttributeTok{span =} \FloatTok{1.25}\NormalTok{,}
      \AttributeTok{size =} \FloatTok{0.25}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ mean),}
               \AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{,}
               \AttributeTok{color =} \StringTok{"seagreen"}\NormalTok{) }\SpecialCharTok{+}  \CommentTok{\#center line}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ quant1),}
               \AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{,}
               \AttributeTok{color =} \StringTok{"seagreen"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\# Bottom line}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ quant2),}
               \AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{,}
               \AttributeTok{color =} \StringTok{"seagreen"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_hline}\NormalTok{(}
      \AttributeTok{yintercept =} \FunctionTok{c}\NormalTok{(target }\SpecialCharTok{+}\NormalTok{ n }\SpecialCharTok{/} \DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(}
\NormalTok{        tolerance}
\NormalTok{      ))), target }\SpecialCharTok{{-}}\NormalTok{ n }\SpecialCharTok{/} \DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(}
\NormalTok{        tolerance}
\NormalTok{      )))),}
      \AttributeTok{color =} \StringTok{"\#012B78"}\NormalTok{,}
      \AttributeTok{linetype =} \StringTok{"solid"}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{scale\_y\_continuous}\NormalTok{(}
      \AttributeTok{limits =}\NormalTok{ ylim,}
      \AttributeTok{expand =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{),}
      \AttributeTok{sec.axis =}
        \FunctionTok{sec\_axis}\NormalTok{(}
...
\NormalTok{          ),}
          \AttributeTok{labels =} \FunctionTok{c}\NormalTok{(}
            \StringTok{"target"}\NormalTok{,}
            \FunctionTok{expression}\NormalTok{(}\FunctionTok{bar}\NormalTok{(x)),}
            \FunctionTok{substitute}\NormalTok{(x[a }\SpecialCharTok{*}\NormalTok{ b], }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(((}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ ref.interval) }\SpecialCharTok{/} \DecValTok{2}
\NormalTok{            ) }\SpecialCharTok{*} \DecValTok{100}\NormalTok{, }\DecValTok{3}\NormalTok{), }\AttributeTok{b =} \StringTok{"\%"}\NormalTok{)),}
            \FunctionTok{substitute}\NormalTok{(x[a }\SpecialCharTok{*}\NormalTok{ b], }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(((ref.interval }\SpecialCharTok{+}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ ref.interval) }\SpecialCharTok{/}
                                                    \DecValTok{2}\NormalTok{)}
\NormalTok{            ) }\SpecialCharTok{*} \DecValTok{100}\NormalTok{,}
            \DecValTok{3}\NormalTok{), }\AttributeTok{b =} \StringTok{"\%"}\NormalTok{)),}
            \FunctionTok{substitute}\NormalTok{(x[tar] }\SpecialCharTok{+}\NormalTok{ a, }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(n }\SpecialCharTok{/} \DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{))),}
            \FunctionTok{substitute}\NormalTok{(x[tar] }\SpecialCharTok{{-}}\NormalTok{ a, }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(n }\SpecialCharTok{/} \DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{)))}
\NormalTok{          )}
\NormalTok{        )}
\NormalTok{    ) }\SpecialCharTok{+} \FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text.y.right =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size =} \DecValTok{15}\NormalTok{))}
  \CommentTok{\# HistChart}
\NormalTok{  x.c }\OtherTok{\textless{}{-}}\NormalTok{ x }\SpecialCharTok{{-}}\NormalTok{ target}
\NormalTok{  temp }\OtherTok{\textless{}{-}} \FunctionTok{hist}\NormalTok{(x.c, }\AttributeTok{plot =} \ConstantTok{FALSE}\NormalTok{)}
\NormalTok{  df3 }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{mid =}\NormalTok{ temp}\SpecialCharTok{$}\NormalTok{mids,}
                    \AttributeTok{density =}\NormalTok{ temp}\SpecialCharTok{$}\NormalTok{density)}
\NormalTok{  width }\OtherTok{\textless{}{-}} \FunctionTok{diff}\NormalTok{(df3}\SpecialCharTok{$}\NormalTok{mid)[}\DecValTok{1}\NormalTok{] }\CommentTok{\# Ancho de cada barra}
\NormalTok{  p3 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(df3, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ mid, }\AttributeTok{y =}\NormalTok{ density)) }\SpecialCharTok{+}
...
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{y =} \StringTok{"Density"}\NormalTok{, }\AttributeTok{x =} \StringTok{"x.c"}\NormalTok{, }\AttributeTok{title =} \FunctionTok{paste}\NormalTok{(}\StringTok{"Histogram of"}\NormalTok{,}\FunctionTok{deparse}\NormalTok{(}\FunctionTok{substitute}\NormalTok{(x)),}\StringTok{"{-} target"}\NormalTok{)) }\SpecialCharTok{+}
    \FunctionTok{theme\_minimal}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{face =} \StringTok{"bold"}\NormalTok{)) }\SpecialCharTok{+}
    \FunctionTok{guides}\NormalTok{(}\AttributeTok{color =} \FunctionTok{guide\_legend}\NormalTok{(}\AttributeTok{title.position =} \StringTok{"top"}\NormalTok{, }\AttributeTok{title.hjust =} \FloatTok{0.5}\NormalTok{)) }\SpecialCharTok{+}
...
\NormalTok{    p3 }\SpecialCharTok{+} \FunctionTok{geom\_vline}\NormalTok{(}
      \FunctionTok{aes}\NormalTok{(}\AttributeTok{xintercept =}\NormalTok{ test}\SpecialCharTok{$}\NormalTok{conf.int[}\DecValTok{1}\NormalTok{], }\AttributeTok{color =} \StringTok{"Confidence interval"}\NormalTok{),}
      \AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{,}
      \AttributeTok{col =} \StringTok{"blue"}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{geom\_vline}\NormalTok{(}
      \FunctionTok{aes}\NormalTok{(}\AttributeTok{xintercept =}\NormalTok{ test}\SpecialCharTok{$}\NormalTok{conf.int[}\DecValTok{2}\NormalTok{], }\AttributeTok{color =} \StringTok{"Confidence interval"}\NormalTok{),}
      \AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{,}
      \AttributeTok{col =} \StringTok{"blue"}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"none"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}
      \AttributeTok{data =} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =} \FunctionTok{density}\NormalTok{(x.c)}\SpecialCharTok{$}\NormalTok{x, }\AttributeTok{y =} \FunctionTok{density}\NormalTok{(x.c)}\SpecialCharTok{$}\NormalTok{y),}
...
\NormalTok{  p3 }\OtherTok{\textless{}{-}}
\NormalTok{    p3 }\SpecialCharTok{+} \FunctionTok{annotation\_custom}\NormalTok{(}\AttributeTok{grob =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{textGrob}\NormalTok{(}
      \AttributeTok{label =} \FunctionTok{c}\NormalTok{(}\FunctionTok{expression}\NormalTok{(}\FunctionTok{paste}\NormalTok{(H[}\DecValTok{0}\NormalTok{], }\StringTok{" : Bias = 0"}\NormalTok{))),}
      \AttributeTok{x =} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
      \AttributeTok{y =} \FunctionTok{unit}\NormalTok{(}\DecValTok{1}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
      \AttributeTok{just =} \FunctionTok{c}\NormalTok{(}\StringTok{"left"}\NormalTok{, }\StringTok{"top"}\NormalTok{),}
      \AttributeTok{gp =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{12}\NormalTok{, }\AttributeTok{fontface =} \StringTok{"bold"}\NormalTok{)}
\NormalTok{    )) }\SpecialCharTok{+}
    \FunctionTok{annotation\_custom}\NormalTok{(}\AttributeTok{grob =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{textGrob}\NormalTok{(}
      \AttributeTok{label =} \FunctionTok{c}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"t{-}value: "}\NormalTok{, }\FunctionTok{round}\NormalTok{(test}\SpecialCharTok{$}\NormalTok{statistic, }\DecValTok{3}\NormalTok{))),}
      \AttributeTok{x =} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
      \AttributeTok{y =} \FunctionTok{unit}\NormalTok{(}\DecValTok{1}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
      \AttributeTok{just =} \FunctionTok{c}\NormalTok{(}\StringTok{"left"}\NormalTok{, }\StringTok{"top"}\NormalTok{),}
      \AttributeTok{gp =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{11}\NormalTok{)}
\NormalTok{    )) }\SpecialCharTok{+}
    \FunctionTok{annotation\_custom}\NormalTok{(}\AttributeTok{grob =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{textGrob}\NormalTok{(}
      \AttributeTok{label =} \FunctionTok{c}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"p{-}value: "}\NormalTok{, }\FunctionTok{round}\NormalTok{(test}\SpecialCharTok{$}\NormalTok{p.value, }\DecValTok{3}\NormalTok{))),}
      \AttributeTok{x =} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.05}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
      \AttributeTok{y =} \FunctionTok{unit}\NormalTok{(}\DecValTok{1}\NormalTok{, }\StringTok{"npc"}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{unit}\NormalTok{(}\FloatTok{0.85}\NormalTok{, }\StringTok{"cm"}\NormalTok{),}
      \AttributeTok{just =} \FunctionTok{c}\NormalTok{(}\StringTok{"left"}\NormalTok{, }\StringTok{"top"}\NormalTok{),}
      \AttributeTok{gp =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{11}\NormalTok{)}
\NormalTok{    ))}
  ...
  \CommentTok{\# Tolerance View}
\NormalTok{  p4 }\OtherTok{\textless{}{-}}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(x), }\AttributeTok{y =}\NormalTok{ x), }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ y)) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{color =}\NormalTok{ col, }\AttributeTok{shape =}\NormalTok{ pch) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{color =}\NormalTok{ col, }\AttributeTok{linetype =} \StringTok{"solid"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ target),}
               \AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{,}
               \AttributeTok{color =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ tolerance[}\DecValTok{1}\NormalTok{]),}
               \AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{,}
               \AttributeTok{color =} \StringTok{"blue"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ tolerance[}\DecValTok{2}\NormalTok{]),}
               \AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{,}
               \AttributeTok{color =} \StringTok{"blue"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ (target }\SpecialCharTok{+}\NormalTok{ n }\SpecialCharTok{/} \DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}
\NormalTok{      tolerance[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{{-}}\NormalTok{ tolerance[}\DecValTok{1}\NormalTok{]}
\NormalTok{    ))), }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ (target }\SpecialCharTok{{-}}\NormalTok{ n }\SpecialCharTok{/} \DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}
\NormalTok{      tolerance[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{{-}}\NormalTok{ tolerance[}\DecValTok{1}\NormalTok{]}
\NormalTok{    ))), }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"Data"} \OtherTok{=}\NormalTok{ col)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
      ...
      \AttributeTok{y =} \StringTok{"x"}\NormalTok{,}
      \AttributeTok{color =} \StringTok{"Variable"}\NormalTok{,}
      \AttributeTok{title =} \StringTok{"Tolerance View"}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{theme\_minimal}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{face =} \StringTok{"bold"}\NormalTok{)) }\SpecialCharTok{+}
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"none"}\NormalTok{)}
  
  \CommentTok{\# Data Box}
\NormalTok{  p2 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =} \DecValTok{0}\NormalTok{, }\AttributeTok{y =} \DecValTok{0}\NormalTok{), }\FunctionTok{aes}\NormalTok{(x, y)) }\SpecialCharTok{+}
    \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
    \FunctionTok{annotate}\NormalTok{(}
      \StringTok{\textquotesingle{}text\textquotesingle{}}\NormalTok{,}
      \AttributeTok{x =} \FloatTok{0.25}\NormalTok{,}
      \AttributeTok{y =} \FloatTok{0.40}\NormalTok{,}
      \AttributeTok{label =} \FunctionTok{paste}\NormalTok{(}\StringTok{"bar(x)=="}\NormalTok{, }\FunctionTok{round}\NormalTok{(mean, }\DecValTok{2}\NormalTok{)),}
...
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{annotate}\NormalTok{(}
      \StringTok{\textquotesingle{}text\textquotesingle{}}\NormalTok{,}
      \AttributeTok{x =} \FloatTok{0.25}\NormalTok{,}
      \AttributeTok{y =} \FloatTok{0.35}\NormalTok{,}
      \AttributeTok{label =} \FunctionTok{paste}\NormalTok{(}\StringTok{"s=="}\NormalTok{, }\FunctionTok{round}\NormalTok{(sd, }\DecValTok{2}\NormalTok{)),}
      \AttributeTok{parse =} \ConstantTok{TRUE}\NormalTok{,}
      \AttributeTok{size =} \DecValTok{3}\NormalTok{,}
      \AttributeTok{hjust =} \DecValTok{0}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{annotate}\NormalTok{(}
      ...
      \AttributeTok{label =} \FunctionTok{paste}\NormalTok{(}\StringTok{"target=="}\NormalTok{, }\FunctionTok{round}\NormalTok{(target, }\DecValTok{5}\NormalTok{)),}
      \AttributeTok{parse =} \ConstantTok{TRUE}\NormalTok{,}
      \AttributeTok{size =} \DecValTok{3}\NormalTok{,}
      \AttributeTok{hjust =} \DecValTok{0}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{annotate}\NormalTok{(}
      ...
      \AttributeTok{label =} \FunctionTok{paste}\NormalTok{(}\StringTok{"C[g]=="}\NormalTok{, }\FunctionTok{round}\NormalTok{(Cg, }\DecValTok{2}\NormalTok{)),}
      \AttributeTok{parse =} \ConstantTok{TRUE}\NormalTok{,}
      \AttributeTok{size =} \DecValTok{3}\NormalTok{,}
      \AttributeTok{hjust =} \DecValTok{0}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{annotate}\NormalTok{(}
      \StringTok{\textquotesingle{}text\textquotesingle{}}\NormalTok{,}
      \AttributeTok{x =} \FloatTok{0.25}\NormalTok{,}
      \AttributeTok{y =} \FloatTok{0.20}\NormalTok{,}
      \AttributeTok{label =} \FunctionTok{paste}\NormalTok{(}\StringTok{"C[gk]=="}\NormalTok{, }\FunctionTok{round}\NormalTok{(Cgk, }\DecValTok{2}\NormalTok{)),}
      \AttributeTok{parse =} \ConstantTok{TRUE}\NormalTok{,}
      \AttributeTok{size =} \DecValTok{3}\NormalTok{,}
      \AttributeTok{hjust =} \DecValTok{0}
\NormalTok{    ) }\SpecialCharTok{+}
...
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{xlim}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\FloatTok{0.15}\NormalTok{, }\FloatTok{0.5}\NormalTok{)) }\SpecialCharTok{+} \FunctionTok{ylim}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\FloatTok{0.5}\NormalTok{))}
...
\StringTok{  114}
\StringTok{  "}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p1 }\SpecialCharTok{+}\NormalTok{ p2 }\SpecialCharTok{+}\NormalTok{ p3 }\SpecialCharTok{+}\NormalTok{ p4 }\SpecialCharTok{+} \FunctionTok{plot\_layout}\NormalTok{(}\AttributeTok{design =}\NormalTok{ design)}
