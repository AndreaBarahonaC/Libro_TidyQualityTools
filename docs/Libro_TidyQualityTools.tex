...
\DocumentationTok{\#\# [1] 0.1969544}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.2140921}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.9491958}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mazo}\SpecialCharTok{$}\NormalTok{.cartas}
\DocumentationTok{\#\#  [1] "10♥" "8♠"  "4♣"  "5♠"  "A♥"  "J♠"  "7♣"  "9♦"  "J♥"  "10♣" "J♣"  "2♣" }
\DocumentationTok{\#\# [13] "10♠" "Q♦"  "4♥"  "Q♠"  "7♠"  "5♣"  "J♦"  "3♣"  "A♣"  "K♣"  "7♦"  "6♦" }
\DocumentationTok{\#\# [25] "2♠"  "A♠"  "9♥"  "2♦"  "8♦"  "6♠"  "K♦"  "3♥"  "A♦"  "9♠"  "3♦"  "8♥" }
\DocumentationTok{\#\# [37] "K♠"  "8♣"  "4♦"  "5♦"  "6♥"  "2♥"  "3♠"  "7♥"  "10♦" "Q♥"  "5♥"  "K♥" }
\DocumentationTok{\#\# [49] "9♣"  "4♠"  "Q♣"  "6♣"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.9435112}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.02469057}
...
## -0.0269569 -0.0039654  0.0002153  0.0039650  0.0289458 
## 
## Coefficients:
...
\NormalTok{                             ) }\SpecialCharTok{+} 
    \FunctionTok{annotation\_custom}\NormalTok{( }\AttributeTok{grob =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{textGrob}\NormalTok{( }\AttributeTok{label =} \FunctionTok{c}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"t{-}value: "}\NormalTok{, }\FunctionTok{round}\NormalTok{(test}\SpecialCharTok{$}\NormalTok{statistic, }\DecValTok{3}\NormalTok{))),}
                                              ...
                                              \AttributeTok{just =} \FunctionTok{c}\NormalTok{(}\StringTok{"left"}\NormalTok{, }\StringTok{"top"}\NormalTok{), }
                                              \AttributeTok{gp =}\NormalTok{ grid}\SpecialCharTok{::}\FunctionTok{gpar}\NormalTok{(}\AttributeTok{fontsize =} \DecValTok{11}\NormalTok{, }\AttributeTok{fontface =} \StringTok{"bold"}\NormalTok{)}
\NormalTok{                                              )}
\NormalTok{                       ) }\SpecialCharTok{+} 
