...
\DocumentationTok{\#\# [1] 0.1863726}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.2243393}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.9750558}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mazo}\SpecialCharTok{$}\NormalTok{.cartas}
\DocumentationTok{\#\#  [1] "2♥"  "3♠"  "Q♥"  "5♣"  "2♦"  "8♠"  "9♥"  "8♦"  "J♦"  "4♥"  "2♠"  "5♠" }
\DocumentationTok{\#\# [13] "K♦"  "10♠" "4♦"  "7♦"  "K♠"  "3♥"  "Q♠"  "10♦" "6♦"  "6♠"  "J♣"  "A♣" }
\DocumentationTok{\#\# [25] "8♥"  "7♣"  "4♣"  "7♥"  "A♠"  "8♣"  "9♦"  "A♦"  "3♣"  "9♣"  "6♥"  "10♣"}
\DocumentationTok{\#\# [37] "K♥"  "Q♣"  "4♠"  "10♥" "3♦"  "J♥"  "9♠"  "J♠"  "Q♦"  "2♣"  "6♣"  "7♠" }
\DocumentationTok{\#\# [49] "5♦"  "5♥"  "A♥"  "K♣"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.903465}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{random}
\DocumentationTok{\#\# [1] 0.897481}
...
## -0.0269575 -0.0039655  0.0002147  0.0039655  0.0289458 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 0.0001130  0.0003097   0.365    0.715    
## V           0.8133656  0.0226393  35.927   <2e-16 ***
## ---
...
\NormalTok{Pareto\_ggplot }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (x, weight, }\AttributeTok{showTable =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{showPlot =} \ConstantTok{TRUE}\NormalTok{, main, col, border, xlab, }\AttributeTok{ylab =} \StringTok{"Frequency"}\NormalTok{, percentVec, ...) }
\NormalTok{\{}
...
\NormalTok{    p }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(data, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{reorder}\NormalTok{(}\FunctionTok{names}\NormalTok{(xtable), }\SpecialCharTok{{-}}\NormalTok{xtable), }\AttributeTok{y =}\NormalTok{ Frequency)) }\SpecialCharTok{+}
      ...
      \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ Cum.Frequency, }\AttributeTok{group =} \DecValTok{1}\NormalTok{, }\AttributeTok{color =} \StringTok{"Cumulative Percentage"}\NormalTok{), }\AttributeTok{size =} \FloatTok{0.5}\NormalTok{) }\SpecialCharTok{+}
      ...
      \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =}\NormalTok{ main)}\SpecialCharTok{+}\FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{,}\AttributeTok{face =} \StringTok{"bold"}\NormalTok{))}
\NormalTok{  \}}
  \ControlFlowTok{else}\NormalTok{ \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{Pareto\_ggplot}\NormalTok{(defectos, }\AttributeTok{col=}\StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{, }\AttributeTok{border=}\StringTok{\textquotesingle{}green\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =} \FunctionTok{c}\NormalTok{(target }\SpecialCharTok{+}\NormalTok{ n}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(tolerance))), target }\SpecialCharTok{{-}}\NormalTok{ n}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(tolerance)))), }\AttributeTok{color =} \StringTok{"\#012B78"}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"solid"}\NormalTok{) }\CommentTok{\# Agregar líneas    }
  \CommentTok{\#Label}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{scale\_y\_continuous}\NormalTok{(}\AttributeTok{limits =}\NormalTok{ ylim, }\AttributeTok{expand =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{),}\AttributeTok{sec.axis =} \FunctionTok{sec\_axis}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ .,}\AttributeTok{breaks =} \FunctionTok{c}\NormalTok{(target,mean,quant1,quant2,target }\SpecialCharTok{+}\NormalTok{ n}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(tolerance))), target }\SpecialCharTok{{-}}\NormalTok{ n}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(}\FunctionTok{diff}\NormalTok{(tolerance)))),}\AttributeTok{labels=}\FunctionTok{c}\NormalTok{(}\StringTok{"target"}\NormalTok{,}\FunctionTok{expression}\NormalTok{(}\FunctionTok{bar}\NormalTok{(x)),}\FunctionTok{substitute}\NormalTok{(x[a }\SpecialCharTok{*}\NormalTok{ b], }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(((}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ ref.interval)}\SpecialCharTok{/}\DecValTok{2}\NormalTok{) }\SpecialCharTok{*} \DecValTok{100}\NormalTok{, }\DecValTok{3}\NormalTok{), }\AttributeTok{b =} \StringTok{"\%"}\NormalTok{)), }\FunctionTok{substitute}\NormalTok{(x[a }\SpecialCharTok{*}\NormalTok{ b], }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(((ref.interval }\SpecialCharTok{+}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ ref.interval)}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)) }\SpecialCharTok{*} \DecValTok{100}\NormalTok{, }
    \DecValTok{3}\NormalTok{), }\AttributeTok{b =} \StringTok{"\%"}\NormalTok{)),}\FunctionTok{substitute}\NormalTok{(x[tar] }\SpecialCharTok{+}\NormalTok{ a, }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(n}\SpecialCharTok{/}\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{))),}\FunctionTok{substitute}\NormalTok{(x[tar] }\SpecialCharTok{{-}}\NormalTok{ a, }\FunctionTok{list}\NormalTok{(}\AttributeTok{a =} \FunctionTok{round}\NormalTok{(n}\SpecialCharTok{/}\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{))))))}\SpecialCharTok{+}\FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text.y.right =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size =} \DecValTok{15}\NormalTok{))}
...
\NormalTok{cgHistChart }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (x, target, tolerance, ref.interval, facCg, facCgk, }
          \AttributeTok{n =} \FloatTok{0.2}\NormalTok{, col, xlim, ylim, main, }\AttributeTok{conf.level =} \FloatTok{0.95}\NormalTok{, }\AttributeTok{cex.val =} \DecValTok{1}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cgHistChart}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{target =}\NormalTok{ target, }\AttributeTok{tolerance =}\NormalTok{ tolerance, }\AttributeTok{ref.interval =}\NormalTok{ ref.interval, }
            \AttributeTok{facCg =}\NormalTok{ facCg, }\AttributeTok{facCgk =}\NormalTok{ facCgk, }\AttributeTok{n =}\NormalTok{ n, }\AttributeTok{col =} \StringTok{"lightblue"}\NormalTok{, }
            \AttributeTok{xlim =}\NormalTok{ xlim, }\AttributeTok{ylim =}\NormalTok{ ylim, }\AttributeTok{main =} \FunctionTok{paste}\NormalTok{(}\StringTok{"Histogram of"}\NormalTok{, }
...
\NormalTok{  p }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(x), }\AttributeTok{y =}\NormalTok{ x), }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ y)) }\SpecialCharTok{+}
    ...
    \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}\FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{,}\AttributeTok{face =} \StringTok{"bold"}\NormalTok{))}\SpecialCharTok{+}
     \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"none"}\NormalTok{)}
